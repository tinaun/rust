...
pub fn default_configuration(sess: &Session) -> ast::CrateConfig {
    ...
    let fam = match sess.target.target.is_like_windows {
    ...
    return vec!(// Target bindings.
         ...
         mk(InternedString::new("target_os"), intern(matches.at(3))),
...
pub fn build_target_config(sopts: &Options) -> Config {
    ...
    let (int_type, uint_type) = match target.target_word_size.as_slice() {
        ...
        w    => fail!("invalid target_word_size {}, handle this better", w),
    };
